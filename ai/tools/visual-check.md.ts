// AUTO-GENERATED from visual-check.md — edit the .md file, then re-run scripts/gen-md-strings.mjs
const content = `After files are generated and the dev server is running, call this tool to verify the project is correct.
