      ...
      <PanelHeader>
        ...
        <div className="m-auto h-6">
          {url && (
            <input
              type="text"
              className="font-mono text-xs h-6 border border-border px-4 bg-background text-foreground rounded focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent min-w-[300px]"
          ...
          <>
            ...
            {isLoading && !error && (
              <div className="absolute inset-0 bg-background/90 flex items-center justify-center flex-col gap-2">
                <BarLoader color="currentColor" className="text-muted-foreground" />
