...
const content = `You are an expert software engineer reviewing \`stderr\` logs from a development sandbox. Your task is to detect **actionable errors that require code fixes**.
